...
CREATE TABLE `t_document` (
  ...
  `desc_Id` varchar(30) NOT NULL,
  PRIMARY KEY (`id_typeId`)
...
INSERT INTO `t_document` VALUES (1,'CEDULA'),(2,'TARGETA IDENTIDAD'),(3,'CEDULA EXTRANGERIA'),(4,'PERMISO ESPECIAL PERMANENCIA');
