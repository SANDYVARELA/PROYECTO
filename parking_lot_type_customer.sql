...
CREATE TABLE `type_customer` (
  `Idtype_customer` varchar(5) NOT NULL,
...
INSERT INTO `type_customer` VALUES ('A1','OCACIONALES','MENOS DE 3 INGRESOS EN LA SEMANA'),('A2','ESPECIALES','MAS DE 3 INGRESOS EN LA SEMANA');
