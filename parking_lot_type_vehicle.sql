...
CREATE TABLE `type_vehicle` (
  `Idtype_vehicle` int(11) NOT NULL,
  `name_type_vehicle` varchar(30) NOT NULL,
  PRIMARY KEY (`Idtype_vehicle`)
...
INSERT INTO `type_vehicle` VALUES (1,'Carro'),(2,'Moto'),(3,'Camioneta'),(4,'Camion');
